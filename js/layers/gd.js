...
addLayer("gd_l", {
    ...
    upgrades: {
        ...
        13: {
            ...
            effect() { return inChallenge("gd_d", 21) ? new Decimal(1) : new Decimal(10).pow(player[this.layer].carmackLevel) },
        ...
        14: {
            ...
            effect() { return inChallenge("gd_d", 21) ? new Decimal(1) : new Decimal(10).pow(player[this.layer].thompsonLevel) },
